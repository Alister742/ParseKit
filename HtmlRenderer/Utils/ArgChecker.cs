...
namespace HtmlRenderer.Utils
{
    ...
    public static class ArgChecker
    {
        ...
        /// <param name="condition">Condtion to assert.</param>
        ...
        /// Validate given argument isn't Null or empty.
        /// </summary>
        /// <typeparam name="T">type of the members in <see cref="arg"/></typeparam>
        /// <param name="arg">argument to validate</param>
        /// <param name="argName">Name of the argument checked</param>
        /// <exception cref="ArgumentNullException">if <paramref name="arg"/> is Null or empty</exception>
        public static void AssertArgNotNullOrEmpty<T>(IEnumerable<T> arg, string argName)
        {
            if (arg == null || !arg.Any())
            {
                throw new ArgumentNullException(argName);
