...
namespace Parse.DOM
{
    ...
    public class Tokenizer
    {
        ...
        private static readonly char[] PLAINTEXT_ARR = { 'p', 'l', 'a', 'i', 'n', 't', 'e', 'x', 't' };

        private static readonly char[] XMP_ARR = { 'x', 'm', 'p' };

        private static readonly char[] TEXTAREA_ARR = { 't', 'e', 'x', 't', 'a', 'r', 'e', 'a' };

        private static readonly char[] IFRAME_ARR = { 'i', 'f', 'r', 'a', 'm', 'e' };

        private static readonly char[] NOEMBED_ARR = { 'n', 'o', 'e', 'm', 'b', 'e', 'd' };

        private static readonly char[] NOSCRIPT_ARR = { 'n', 'o', 's', 'c', 'r', 'i', 'p', 't' };

        private static readonly char[] NOFRAMES_ARR = { 'n', 'o', 'f', 'r', 'a', 'm', 'e', 's' };

        public ITreeBuilder TokenHandler { get; private set; }
        ...
        public void SetStateAndEndTagExpectation(int specialTokenizerState, String endTagExpectation)
        {
            ...
            this.endTagExpectation = new ElementName(endTagExpectation);
        ...
        {
            doctypeName = strBuf.ToCharString();
        }
        ...
        public void Fatal(string message)
        {
            ...
            //GlobalLog.Err(new Exception(message), "Fatal in Tokenizer, line " + LineNumber);
        }
        ...
        private void ErrTreeBuilder(string message)
        {
            Err(message); // TODO
        }
        ...
        private string CharToString(char[] strBuf)
        {
        ...
        private int EmitCurrentTagToken(bool selfClosing, int pos)
        {
            ...
            HtmlAttributes attrs = (attributes == null ? HtmlAttributes.EMPTY_ATTRIBUTES : attributes);
            if (endTag)
            {
                /*
        ...
        public bool InternalEncodingDeclaration(string internalCharset)
        {
            ...
            {
                EncodingDeclared(internalCharset);
            }
