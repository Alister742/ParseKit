...
namespace HtmlRenderer
{
    ...
    public sealed class CssData
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Dictionary<string, List<CssBlock>>> _mediaBlocks = new Dictionary<string, Dictionary<string, List<CssBlock>>>();
        ...
        internal CssData()
        {
            _mediaBlocks.Add("all", new Dictionary<string, List<CssBlock>>());
        }
        ...
        public IEnumerable<CssBlock> GetCssBlock(string className, string media = "all")
        {
            ...
            return block ?? Enumerable.Empty<CssBlock>();
        }
        ...
        public void AddCssBlock(string media, CssBlock cssBlock)
        {
            ...
            if(!_mediaBlocks.TryGetValue(media, out mid))
            {
                mid = new Dictionary<string, List<CssBlock>>();
