...
{
    public static class HTMLAttrContainer
    {

    }

    public static class HTMLTagContainer
    {
        static HTMLTagContainer()
        {
            InitStringResources();
        }

        private static void InitStringResources()
        {
            InitFormatting();
            InitSpecialTags();
            InitPTagCloses();
