...
namespace HtmlRenderer.Dom
{
    ...
    internal abstract class CssBoxProperties
    {
        ...
        public string LineHeight
        {
            ...
            set { _lineHeight = CssValueParser.ParseLength(value, Size.Height, this) + "px"; }
        }
            ...
            get
            {
                if (float.IsNaN(_actualMarginTop))
                {
                    if (MarginTop == CssConstants.Auto)
                        MarginTop = "0";
                    _actualMarginTop = CssValueParser.ParseLength(MarginTop, Size.Width, this);
                }
            ...
            get
            {
                if (float.IsNaN(_actualMarginLeft))
                {
                    if (MarginLeft == CssConstants.Auto) 
                        MarginLeft = "0";
                    _actualMarginLeft = CssValueParser.ParseLength(MarginLeft, Size.Width, this);
                }
            ...
            get
            {
                if (float.IsNaN(_actualMarginBottom))
                {
                    if (MarginBottom == CssConstants.Auto) 
                        MarginBottom = "0";
                    _actualMarginBottom = CssValueParser.ParseLength(MarginBottom, Size.Width, this);
                }
            ...
            get
            {
                if (float.IsNaN(_actualMarginRight))
                {
                    if (MarginRight == CssConstants.Auto) 
                        MarginRight = "0";
                    _actualMarginRight = CssValueParser.ParseLength(MarginRight, Size.Width, this);
                }
        ...
        public Font ActualFont
        {
            get
            {
                if (_actualFont == null)
                {
                    ...
                    if (string.IsNullOrEmpty(FontSize)) { FontSize = CssConstants.FontSize + "pt"; }
                    ...
                    _actualFont = CssUtils.GetCachedFont(FontFamily, fsize, st);
                }
                return _actualFont;
            }
        }
        ...
        public float FontAscent
        {
            get
            {
                ...
                {
                    _fontAscent = CssUtils.GetAscent(ActualFont);
                }
                return _fontAscent;
            }
        }
        ...
        public float FontLineSpacing
        {
            get
            {
                ...
                {
                    _fontLineSpacing = CssUtils.GetLineSpacing(ActualFont);
                }
        ...
        public float FontDescent
        {
            get
            {
                ...
                {
                    _fontDescent = CssUtils.GetDescent(ActualFont);
                } return _fontDescent;
            }
        }
        ...
        /// <summary>
        /// Measures the width of whitespace between words.
        /// </summary>
        protected void MeasureWordSpacing(Graphics g)
        {
