...
namespace HtmlRenderer.Utils
{
    ...
    internal sealed class SelectionHandler
    {
        ...
        /// </summary>
        private CssBoxWord _selectionStart;
        ...
        /// </summary>
        private CssBoxWord _selectionEnd;
        ...
        public void HandleMouseDown(Control parent, Point loc)
        {
        ...
        /// <returns>is the mouse was in selection before releasing</returns>
        public bool HandleMouseUp(Control parent, MouseButtons button)
        {
            var inSelection = _inSelection;
        ...
        public float GetSelectedEndOffset(CssBoxWord word)
        {
        ...
        private void CheckSelectionDirection()
        {
            ...
            else if (_selectionStart.LineBox == _selectionEnd.LineBox)
            {
