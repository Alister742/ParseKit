...
using Browser_Emulator.zSource;
...
{ 
    ...
    //Description(SR.DescriptionWebBrowser),
    ...
    public class WebBrowser : WebBrowserBase {
        ...
        ///     </para>
        /// </devdoc> 
        [Description(SR.WebBrowserAllowNavigationDescr), 
        Category(SR.CatBehavior), DefaultValue(true)]
        ...
        ///     </para> 
        /// </devdoc> 
        [Description(SR.WebBrowserAllowWebBrowserDropDescr),
        Category(SR.CatBehavior), DefaultValue(true)] 
        ...
        ///     </para>
        /// </devdoc>
        [Description(SR.WebBrowserScriptErrorsSuppressedDescr), 
        Category(SR.CatBehavior), DefaultValue(false)]
        ...
        ///     </para> 
        /// </devdoc>
        [Description(SR.WebBrowserWebBrowserShortcutsEnabledDescr), 
        Category(SR.CatBehavior), DefaultValue(true)] 
        ...
        public HtmlDocument Document {
            get {
                ...
                if (objDoc != null) {
                    UnsafeNativeMethods.IHTMLDocument2 iHTMLDocument2 = objDoc as UnsafeNativeMethods.IHTMLDocument2; 
        ...
        ///     </para>
        /// </devdoc>
        [Description(SR.WebBrowserIsOfflineDescr), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] 
        ...
        ///     </para>
        /// </devdoc>
        [Description(SR.WebBrowserIsWebBrowserContextMenuEnabledDescr),
        Category(SR.CatBehavior), DefaultValue(true)] 
        ...
        EditorBrowsable(EditorBrowsableState.Never),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), 
        Category(SR.CatLayout), Description(SR.ControlOnPaddingChangedDescr)
        ] 
        ...
        [
            Description(SR.WebBrowserUrlDescr), 
            Bindable(true),
            Category(SR.CatBehavior),
        ...
        ///     </para>
        /// </devdoc>
        [Description(SR.WebBrowserScrollBarsEnabledDescr),
        Category(SR.CatBehavior), DefaultValue(true)] 
        ...
        ///     </para>
        /// </devdoc> 
        [Browsable(false), Category(SR.CatPropertyChanged), Description(SR.WebBrowserCanGoBackChangedDescr)]
        ...
        ///     </para>
        /// </devdoc> 
        [Browsable(false), Category(SR.CatPropertyChanged), Description(SR.WebBrowserCanGoForwardChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [Category(SR.CatBehavior), Description(SR.WebBrowserDocumentCompletedDescr)]
        ...
        ///     </para>
        /// </devdoc> 
        [Browsable(false), Category(SR.CatPropertyChanged), Description(SR.WebBrowserDocumentTitleChangedDescr)]
        ...
        ///     </para> 
        /// </devdoc>
        [Browsable(false), Category(SR.CatPropertyChanged), Description(SR.WebBrowserEncryptionLevelChangedDescr)] 
        ...
        ///     </para> 
        /// </devdoc>
        [Category(SR.CatBehavior), Description(SR.WebBrowserFileDownloadDescr)] 
        ...
        ///     </para> 
        /// </devdoc>
        [Category(SR.CatAction), Description(SR.WebBrowserNavigatedDescr)] 
        ...
        ///     </para>
        /// </devdoc> 
        [Category(SR.CatAction), Description(SR.WebBrowserNavigatingDescr)] 
        ...
        ///     </para>
        /// </devdoc> 
        [Category("SR.CatAction"), Description("SR.WebBrowserNewWindowDescr")] 
        ...
        ///     </para> 
        /// </devdoc>
        [Category("CatAction"), Description("SR.WebBrowserProgressChangedDescr")] 
        ...
        ///     </para>
        /// </devdoc> 
        [Browsable(false), Category("SR.CatPropertyChanged"), Description("SR.WebBrowserStatusTextChangedDescr")]
...
#region ShimSupport 
       ...
       internal HtmlShimManager ShimManager {
        ...
        internal static void EnsureUrlConnectPermission(Uri url) {
            //
            WebPermission permission = new WebPermission(NetworkAccess.Connect, url.ToString());
            permission.Demand(); 
        }
