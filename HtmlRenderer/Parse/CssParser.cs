...
namespace HtmlRenderer.Parse
{
    ...
    internal static class CssParser
    {
        ...
        public static CssBlock ParseCssBlockImp(string className, string blockSource)
        {
        ...
        public static string ParseFontFamilyProperty(string propValue)
        {
            int start = 0;
        ...
        {
            string borderWidth = RegexParserUtils.Search(RegexParserUtils.CssBorderWidth, propValue);
            string borderStyle = RegexParserUtils.Search(RegexParserUtils.CssBorderStyle, propValue);
            string borderColor = RegexParserUtils.Search(RegexParserUtils.CssColors, propValue);
